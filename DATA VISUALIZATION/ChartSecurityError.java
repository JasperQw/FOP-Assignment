...
public class ChartSecurityError extends Application {
   public void start(Stage stage) {                 
      ...
      barChart.setTitle("Number of Security Violation Errors According Month");
        
      //Prepare XYChart.Series objects by setting data       
      XYChart.Series<String, Number> series1 = new XYChart.Series<>();
      series1.setName("Error");
      series1.getData().add(new XYChart.Data<>("June", 3));
      series1.getData().add(new XYChart.Data<>("July", 4));
      ...
      series1.getData().add(new XYChart.Data<>("November", 3));
