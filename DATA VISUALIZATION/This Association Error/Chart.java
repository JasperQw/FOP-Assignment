...
public class Chart extends Application {
   public void start(Stage stage) {                 
      ...
      barChart.setTitle("Number of This Association Error According Month");
        
      //Prepare XYChart.Series objects by setting data       
      XYChart.Series<String, Number> series1 = new XYChart.Series<>();
      series1.setName("This association error");
      series1.getData().add(new XYChart.Data<>("June", 38));
      series1.getData().add(new XYChart.Data<>("July", 0));
      series1.getData().add(new XYChart.Data<>("August", 56));
      series1.getData().add(new XYChart.Data<>("September", 9));
      series1.getData().add(new XYChart.Data<>("October", 5));
      series1.getData().add(new XYChart.Data<>("November", 35));
