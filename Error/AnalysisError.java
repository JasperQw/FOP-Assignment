public class AnalysisError{
    ...
    public void Max(){
          if(Error6 > Error7 && Error6 > Error8 && Error6 > Error9 && Error6 > Error10 && Error6 > Error11 && Error6 > Error12){
                    System.out.println("The month that has the most errors: June ");
                }
                else if(Error7 > Error6 && Error7 > Error8 && Error7 > Error9 && Error7 > Error10 && Error7 > Error11 && Error7 > Error12){
                    System.out.println("The month that has the most errors: July");
                }
                else if(Error8 > Error6 && Error8 > Error7 && Error8 > Error9 && Error8 > Error10 && Error8 > Error11 && Error8 > Error12){
                    System.out.println("The month that has the most errors: August");
                }
                else if(Error9 > Error6 && Error9 > Error7 && Error9 > Error8 && Error9 > Error10 && Error9 > Error11 && Error9 > Error12){
                    System.out.println("The month that has the most errors: September");
                }
                else if(Error10 > Error6 && Error10 > Error7 && Error10 > Error8 && Error10 > Error9 && Error10 > Error11 && Error10 > Error12){
                    System.out.println("The month that has the most errors: October");
                }
                else if(Error11 > Error6 && Error11 > Error7 && Error11 > Error8 && Error11 > Error9 && Error11 > Error10 && Error11 > Error12){
                    System.out.println("The month that has the most errors: November");
                }
                else{
                    System.out.println("The month that has the most errors: December");
                }
    }
    public void Min(){
          if(Error6 < Error7 && Error6 < Error8 && Error6 < Error9 && Error6 < Error10 && Error6 < Error11 && Error6 < Error12){
                    System.out.println("The month that has the least error: June ");
                }
                else if(Error7 < Error6 && Error7 < Error8 && Error7 < Error9 && Error7 < Error10 && Error7 < Error11 && Error7 < Error12){
                    System.out.println("The month that has the least error: July");
                }
                else if(Error8 < Error6 && Error8 < Error7 && Error8 < Error9 && Error8 < Error10 && Error8 < Error11 && Error8 < Error12){
                    System.out.println("The month that has the least error: August");
                }
                else if(Error9 < Error6 && Error9 < Error7 && Error9 < Error8 && Error9 < Error10 && Error9 < Error11 && Error9 < Error12){
                    System.out.println("The month that has the least error: September");
                }
                else if(Error10 < Error6 && Error10 < Error7 && Error10 < Error8 && Error10 < Error9 && Error10 < Error11 && Error10 < Error12){
                    System.out.println("The month that has the least error: October");
                }
                else if(Error11 < Error6 && Error11 < Error7 && Error11 < Error8 && Error11 < Error9 && Error11 < Error10 && Error11 < Error12){
                    System.out.println("The month that has the least error: November");
                }
                else{
                    System.out.println("The month that has the least error: December");
                }
    }
    public void Average(){
        double average = 0;
