    ...
    public static void main(String[] args) throws Exception {
            ...
            while(content.hasNextLine()){    
                String temp=content.nextLine();
                    ...
                    String [] columns = {"Month", "Number of Error", "Qos Long", "Qos Normal"};
        ...
        Scanner sc = new Scanner(new FileReader("This Association Error.txt"));
            ...
            HashMap<String, Integer> counts = new HashMap<>();
                ...
                System.out.println("\nUser         The Number of Error Made by Each User");
                System.out.println("---------------------------------------------------");
                ...
                String title = "Users with Number of This Association Error";
                   String [] columns = {"Users", "Number of Error by Each User"};
                    Object data[][] = {{"yatyuen",1 },
                                       {"farhatabjani", 3},
                                       {"aah",12},
                                       {"lin0618", 4},
                                       {"janvik ", 4},
